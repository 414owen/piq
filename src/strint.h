...
int8_t parse_int8_base10(flow_type *flow, const char *str, const size_t str_len);
...
int8_t parse_int8_base16(flow_type *flow, const char *str, const size_t str_len);
